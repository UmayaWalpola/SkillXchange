            ...
            <form method="POST" class="form">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="5"><?= htmlspecialchars($task->description ?? '') ?></textarea>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text">Use the board to change status</small>
                        </div>
                    </div>
                </div>
                <div class="form-section">
