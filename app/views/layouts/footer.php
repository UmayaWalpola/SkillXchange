    ...
    <div class="footer-minimal-container">
        ...
        <div class="footer-minimal-top">
            <div class="footer-contact">
                <a href="mailto:hello@skillxchange.com" class="footer-email">hello@skillxchange.com</a>
                <a href="tel:+17175251031" class="footer-phone">(717) 525-1031</a>
            </div>
...
<!-- JavaScript -->
<script src="<?php echo URLROOT; ?>/assets/js/main.js" defer></script>
<script src="<?php echo URLROOT ?>/public/assets/js/formtoggle.js" defer></script>
</body>
</html>