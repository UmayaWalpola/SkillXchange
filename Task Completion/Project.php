...
class Project {
    ...
    public function createProject($data) {
        $this->db->query("INSERT INTO projects (organization_id, name, description, category, status, required_skills, max_members, project_type, start_date, end_date) VALUES (:organization_id, :name, :description, :category, :status, :required_skills, :max_members, :project_type, :start_date, :end_date)");
        ...
        $this->db->bind(':project_type', $data['project_type'] ?? 'commercial');
    ...
    public function updateProject($data) {
        ...
        $this->db->query("UPDATE projects SET name = :name, description = :description, category = :category, status = :status, required_skills = :required_skills, max_members = :max_members, project_type = :project_type, start_date = :start_date, end_date = :end_date, updated_at = CURRENT_TIMESTAMP WHERE id = :id AND organization_id = :org_id");
